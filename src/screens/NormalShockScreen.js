        ...
        <View style={styles.card}>
          ...
          {results ? (
            <View>
              ...
              <ResultRow label="P2 / P1" value={formatNumber(results.pressureRatio)} />
              <ResultRow label="ρ2 / ρ1" value={formatNumber(results.densityRatio)} />
              <ResultRow label="T2 / T1" value={formatNumber(results.temperatureRatio)} />
              <ResultRow label="P02 / P01" value={formatNumber(results.totalPressureRatio)} />
              <ResultRow label="P1 / P02" value={formatNumber(results.staticToTotal2)} />
            </View>
          ) : (
